...
namespace E_Receptionist
{
    public partial class temp : Form
    {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                else if (st.Contains("new line the") || st.Contains("dont you the") || st.Contains("those") || st.Contains("holish") || st.Contains("venice") || st.Contains("computer") || st.Contains("science") || st.Contains("department") || st.Contains("many unread") || st.Contains("the path"))
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        MessageBox.Show("First floor main building "); //computer science department
                        string projectPath = Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName;
                        // MessageBox.Show(projectPath);
                ...
                else if (st.Contains("is") || st.Contains("i") || st.Contains("s") || st.Contains("information") || st.Contains("science") || st.Contains("department") || st.Contains("and") || st.Contains("the holish") || st.Contains("holish") || st.Contains("and while") || st.Contains("polish") || st.Contains("owners"))
                {
      ...
      /*  private void button1_Click(object sender, EventArgs e)
        ...
        */
       /* private void voices_FormClosing(object sender, FormClosingEventArgs e)
        {
            recthread.Abort();
            recthread = null;
